...
function getContent(e){
	...
	jquery_qustn.ajax({
				url: baseURL+"json/artifacts.json",
				type: 'GET',
				jsonpCallback: 'callback',
				async: false,
				contentType: "application/json",
...
function firstLogin(){
	...
	jquery_qustn('#qustn-popup-msg p').html('I’m "Q"! If at any point of time you need help, simply click on me');
