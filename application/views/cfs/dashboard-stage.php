...
<title>Capabiliti for Support</title>
<!-- Bootstrap Core CSS -->
<link href="<?php echo base_url();?>assets/web_assets/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">

<!-- MetisMenu CSS -->
<link href="<?php echo base_url();?>assets/web_assets/bower_components/metisMenu/dist/metisMenu.min.css" rel="stylesheet">
		...
		?>
			<li <?php echo ($i==1)?'class="active"':''?>>
					<a href="javascript:void(0);" class="loadModule" id="moduleHead-<?php echo $i;?>" data-module="<?php echo $leftModuleValues->id;?>" data-js-module="<?php echo $i;?>">
						...
						<span class="_first"><?php echo $leftModuleValues->title;?></span>
			  ...
			  <button type="button" class="close" aria-hidden="true">×</button>
				<div class="row">
					...
					<div class="form-inline">
						...
						<label class="createdDate">12 January 2016</label>
					</div>
					<div class="form-inline">
						<label for="artifactTag">Size</label>
						<label class="size">31.3 MB</label>
					</div>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/web_assets/js/filer-2.js"></script>

<!-- Custom Theme JavaScript --> 
<script src="<?php echo base_url();?>assets/web_assets/dist/js/sb-admin-2.js"></script>

<!-- custom jQuery --> 
<script src="<?php echo base_url();?>assets/web_assets/js/script-2.js"></script> 
